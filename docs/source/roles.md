...
> **Rôles** : auteur, rédacteur, administrateur, rédacteur en chef, secrétaire de rédaction, webmaster, rédacteur invité, préparateur de copie, relecteur, membre

Il existe **neuf rôles** dans Episciences, chacun ayant des droits associés à des fonctionnalités.
...
+ **Membre** : rôle par défaut attribué à toute personne se créant un compte sur le site d’une épi-revue. Permet notamment de soumettre un article.
